...
--INSERT INTO restaurante(id, nome, taxa_frete, cozinha_id) values(1,'Fogo de chão',20,1);
--INSERT INTO restaurante(id, nome, taxa_frete, cozinha_id) values(2,'Churrasco brasileiro',15,2);
